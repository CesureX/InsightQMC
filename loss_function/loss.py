...
class LossFn(Protocol):
    def __call__(
            ...
            key: chex.PRNGKey,
            data: networks.KANetsData, ) -> Tuple[jnp.ndarray, AuxiliaryLossData]:
...
def make_loss(network,
  ...
  batch_network = vmap(network, in_axes=(None, 0, None, None, None), out_axes=0)
  # params, pos, spins, atoms, charges
