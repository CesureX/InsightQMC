...
# Select the basis and its parameter-count matching preset from train/config.py.
...
cfg.mkan.required_parameters = dict(
    cfg.mkan.basis_required_parameters[basis]
)
cfg.output.resume = False

# Keep every basis result in a separate directory.
